...
export default function Login() {
  ...
  useEffect(() => {
    // Referral capture logic removed to save Firestore resources
  }, []);
      ...
      >
        <Card className="border-none shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2.5rem] overflow-hidden bg-white">
          <CardHeader className="space-y-4 text-center pb-8 pt-10">
            <div className="mx-auto w-16 h-16 bg-primary/10 rounded-[1.5rem] flex items-center justify-center mb-2">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-gray-500 text-base font-medium">
                Sign in to manage your social media growth
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="p-8 pt-0 space-y-6">
            ...
            <Button 
              variant="outline" 
              className="w-full h-14 rounded-2xl border-2 border-gray-100 hover:border-primary/20 hover:bg-primary/5 transition-all duration-300 flex items-center justify-center gap-3 group shadow-sm"
